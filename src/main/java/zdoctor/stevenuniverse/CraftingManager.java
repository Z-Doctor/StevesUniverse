...
//		GameRegistry.addRecipe(new ItemStack(SUItems.rubyGem, 1), new Object[]{"RXR","XGX","RXR", 'X', Items.gold_ingot, 'R', Blocks.redstone_block, 'G', SUItems.ruby});
//		GameRegistry.addRecipe(new ItemStack(SUItems.sapphireGem, 1), new Object[]{"RXR","XGX","RXR", 'X', Items.gold_ingot, 'R', Blocks.redstone_block, 'G', SUItems.sapphire});
...
//		GameRegistry.addRecipe(new ItemStack(SUItems.roseGem, 1), new Object[]{"RXR","XGX","RXR", 'X', Items.gold_ingot, 'R', Blocks.redstone_block, 'G', SUItems.rose});
...
//		GameRegistry.addShapelessRecipe(new ItemStack(SUItems.malachite, 1), new ItemStack(Items.dye, 1, 4), SUItems.jasper);
	...
	public static void addSmeltingRec(){
		// GameRegistry.addSmelting( SUBlocks.amethyst_ore, new
		// ItemStack(SUItems.amethyst, 1), 20.0f);
		// GameRegistry.addSmelting( SUBlocks.pearl_ore, new
		// ItemStack(SUItems.pearl, 1), 20.0f);
		// GameRegistry.addSmelting( SUBlocks.rose_ore, new
		// ItemStack(SUItems.rose, 1), 20.0f);
		// GameRegistry.addSmelting( SUBlocks.jasper_ore, new
		// ItemStack(SUItems.jasper, 1), 20.0f);
		// GameRegistry.addSmelting( SUBlocks.peridot_ore, new
		// ItemStack(SUItems.peridot, 1), 20.0f);
		// GameRegistry.addSmelting( SUBlocks.ruby_ore, new
		// ItemStack(SUItems.ruby, 1), 20.0f);
		// GameRegistry.addSmelting( SUBlocks.sapphire_ore, new
		// ItemStack(SUItems.sapphire, 1), 20.0f);
		//
