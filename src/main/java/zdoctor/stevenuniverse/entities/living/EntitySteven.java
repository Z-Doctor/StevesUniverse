...
import zdoctor.stevenuniverse.renderers.living.RenderSteven;

public class EntitySteven extends EntityMob implements IRenderLiving {

	public EntitySteven(World p) {
		super(p);
	}
