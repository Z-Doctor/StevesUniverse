...
import zdoctor.stevenuniverse.renderers.living.RenderRuby;

public class EntityRuby extends EntityMob implements IRenderLiving {

	public EntityRuby(World u) {
		super(u);
	...
	public void onLivingUpdate() {
		...
		for (i = 0; i < 4; ++i) {
			...
			if (this.world.getBlockState(pos).getBlock().isFlammable(world, pos, EnumFacing.UP)
					&& SUBlocks.ash_block.canPlaceBlockAt(this.world, pos)) {
				this.world.setBlockState(pos, SUBlocks.ash_block.getDefaultState());
			}
		}
	}
