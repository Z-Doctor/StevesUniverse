...
import zdoctor.stevenuniverse.renderers.living.RenderOpal;

public class EntityOpal extends EntityMob implements IRenderLiving {

	public EntityOpal(World p) {
		super(p);
		setSize(1.0F, 7.0F);
	}
