...
import zdoctor.stevenuniverse.renderers.living.RenderLapisLazuli;

public class EntityLapisLazuli extends EntityMob implements IRenderLiving {
	...
	public Class<? extends RenderLiving> getLivingRenderer() {
		return RenderLapisLazuli.class;
	}
