...
import zdoctor.stevenuniverse.renderers.living.RenderAmethyst;

public class EntityAmethyst extends EntityMob implements IRenderLiving {

	public EntityAmethyst(World p) {
		super(p);
