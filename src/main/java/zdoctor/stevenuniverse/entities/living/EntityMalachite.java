...
import zdoctor.stevenuniverse.renderers.living.RenderMalachite;

public class EntityMalachite extends EntityMob implements IRenderLiving {

	public EntityMalachite(World p) {
		super(p);
		setSize(5.0F, 15.0F);
	}
