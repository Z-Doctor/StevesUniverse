package zdoctor.stevenuniverse.entities;
...
public class EntityAmethystWhip extends EntityThrowable
{
	...
	public EntityAmethystWhip(World world) {
		super(world);
	}

	public EntityAmethystWhip(World world, EntityLivingBase entity) {
		super(world, entity);
	}

	public EntityAmethystWhip(World world, double x, double y, double z) {
		super(world, x, y, z);
	}
	...
	protected boolean canUpdate() {
		...
		if (!isDead && thrower instanceof EntityPlayer && ((EntityPlayer) thrower).isUsingItem()) {
			return thrower.getHeldItem() != null && thrower.getHeldItem().getItem() instanceof AmethystWhip;
		} else {
			return false;
		}
	}
