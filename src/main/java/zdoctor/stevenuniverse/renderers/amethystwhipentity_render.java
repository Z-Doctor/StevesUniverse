package zdoctor.stevenuniverse.renderers;
...
public class amethystwhipentity_render extends Render
{
	...
	public void doRender(Entity entity, double x, double y, double z, float yaw, float partialTick) {
		renderLeash((EntityAmethystWhip) entity, x, y, z, yaw, partialTick);
	}
	...
	protected void renderLeash(EntityAmethystWhip whip, double x, double y, double z, float yaw, float partialTick) {
		...
		if (entity != null) {
			...
			if (whip.isInGround()) {
				whip.posX = whip.getDataWatcher().getWatchableObjectFloat(EntityAmethystWhip.HIT_POS_X);
				whip.posY = whip.getDataWatcher().getWatchableObjectFloat(EntityAmethystWhip.HIT_POS_Y);
				whip.posZ = whip.getDataWatcher().getWatchableObjectFloat(EntityAmethystWhip.HIT_POS_Z);
