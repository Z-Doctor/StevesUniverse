...
public class rose_heart extends Item{
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer){
		...
		entityplayer.inventory.addItemStackToInventory(new ItemStack( SUItems.rose_sword, 1));
		entityplayer.inventory.addItemStackToInventory(new ItemStack( SUItems.rose_shield, 1));
